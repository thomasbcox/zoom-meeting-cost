...
//
// PRIVACY: like buildSharedState(), this must never carry the presenter's
// private rate table, aliases, per-participant names, or individual rates. The
// overlay shows aggregate numbers only, so only aggregate numbers are sent.
